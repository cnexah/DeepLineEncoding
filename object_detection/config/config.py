...
## path
path = edict()
path.data_path = "/disk0/data/kitti/training" # used in visualDet3D/data/.../dataset
path.test_path = "/disk0/data/kitti/testing" # used in visualDet3D/data/.../dataset
...
head_loss = edict(
    ...
    balance_weight   = [20.0],
    regression_weight = [1, 1, 1, 1, 1, 1, 5, 1, 1, 0.5, 0.5, 0.5, 1], #[x, y, w, h, cx, cy, z, sin2a, cos2a, w, h, l]
)
head_test = edict(
    score_thr=0.75,
    cls_agnostic = False,
